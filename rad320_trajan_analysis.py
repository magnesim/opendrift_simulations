...
plot_timesteps = [12,24]    # hours after release
                            # add more time indices as needed



# Loop over selected time steps
# and plot concentration maps
for tt in plot_timesteps:
